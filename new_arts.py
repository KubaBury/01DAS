...
df1=pd.read_csv ('data/article_archive_all_9_12_10am_cat.csv')
df2=pd.read_csv ('data/article_archive_13_12_all.csv')
...
df.to_csv('data/article_archive_allnew.csv',index=False, header=df.columns, mode='a')
