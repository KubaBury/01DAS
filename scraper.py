...
link3 = 'https://denikn.cz/sport/feed?ref=inc'
...
link7 = 'https://www.irozhlas.cz/rss/irozhlas/section/zpravy-domov'
def feedparse(link):
...
feed2dict('data/article_archive_idnes13_12.csv','Domov',columns,link3)
